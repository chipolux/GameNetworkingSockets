...
#include "igamenetworkingutils.h"
class IGameNetworkingConnectionSignaling;

typedef uint64 uint64_gameid; // Used when passing or returning CSteamID
...
STEAMNETWORKINGSOCKETS_INTERFACE void SteamAPI_GameNetworkingIdentity_SetSteamID( GameNetworkingIdentity* self, uint64_gameid gameID );
STEAMNETWORKINGSOCKETS_INTERFACE uint64_gameid SteamAPI_GameNetworkingIdentity_GetSteamID( GameNetworkingIdentity* self );
STEAMNETWORKINGSOCKETS_INTERFACE void SteamAPI_GameNetworkingIdentity_SetSteamID64( GameNetworkingIdentity* self, uint64 gameID );
