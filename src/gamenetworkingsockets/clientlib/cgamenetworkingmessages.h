...
{
	GameNetworkingMessagesSession( const GameNetworkingIdentity &identityRemote, CGameNetworkingMessages &gameNetworkingP2P );
	virtual ~GameNetworkingMessagesSession();

	GameNetworkingIdentity m_identityRemote;
	CGameNetworkingMessages &m_gameNetworkingMessagesOwner;
...
public:
	...
	CGameNetworkingMessages( CGameNetworkingSockets &gameNetworkingSockets );
	...
	CGameNetworkingSockets &m_gameNetworkingSockets;
