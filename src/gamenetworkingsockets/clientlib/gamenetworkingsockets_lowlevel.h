...
public:
	...
	///
	/// Packets sent through this method are subject to fake loss (gamedatagram_fakepacketloss_send),
	/// lag (gamedatagram_fakepacketlag_send and gamedatagram_fakepacketreorder_send), and
	/// duplication (gamedatagram_fakepacketdup_send)
